...
class AlertSystem {
 ...
 console.log(' Email transporter setup failed (non-critical):', error.message);
 ...
 suspicious_patterns: ` Security Alert: Suspicious Account Activity`,
...
${JSON.stringify(alertData.details, null, 2)}
 ...
 console.log(` [ALERT CONFIG] Updated threshold for ${alertType}: ${newThreshold}`);
 ...
 console.log(` [ALERT SYSTEM] Configuration updated:`, newConfig);
